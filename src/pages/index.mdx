...
imageOne: /images/home_pic01.jpg
imageTwo: /images/home_pic02.jpg
imageThree: /images/home_pic03.jpg
---
...
<One />
<SpotlightContainer>
  <Spotlight imageSrc={`${frontmatter.imageOne}`} header="Our Mission" text="Our Mission">
  ...
  <Spotlight imageSrc={`${frontmatter.imageTwo}`} header="Donate" text="Donate">
  ...
  <Spotlight imageSrc={`${frontmatter.imageThree}`} header="Who We Are" text="Who We Are">
